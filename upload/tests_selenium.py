...
from .models import RefEtudes, JonctionUtilisateurEtude, SuiviUpload, RefControleQualite, JonctionEtapeSuivi, DossierUpload, RefEtatEtape, RefEtapeEtude, SuiviDocument, RefInfocentre
...
class AccountTestCase(LiveServerTestCase):
	...
	def test_page_upload(self):
		...
		self.assertEqual(selenium.find_element_by_name("titre_form").get_attribute("innerHTML").splitlines()[0], name_index)
