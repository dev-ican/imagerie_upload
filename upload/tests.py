...
class TestApp(TestCase):
	...
	def setUp(self):
			...
			test_etude2 = RefEtudes.objects.create(
				nom="test_etude2", date_ouverture='2020-02-02')
			...
			test_centre = RefInfocentre.objects.create(nom="Centre_test1", numero="1258", date_ajout='2020-02-02')
			test_centre.save()
			test_centre = RefInfocentre.objects.create(nom="Centre_test2", numero="12587", date_ajout='2020-02-02')
			test_centre.save()
...
#---------------------------------------------------------------------------------------------
	...
	def test_etude_edit(self):
		...
		post_edit_etude = self.client.post(reverse('etude_edit',args=(id_projet,)), {'nom':'test_edit','date_ouverture':'2020-02-02'})
...
#---------------------------------------------------------------------------------------------
	...
	def test_admin_user(self):
		...
		for item in var_user:
			self.assertIn(item.username, ['testuser1', 'testuser2'])

		dict_user = {'username':'test_user_create', 'email':'test_email@gmail.com', 'pass_first':'testtest12345', 'pass_second':'testtest12345', 'nom':'', 'numero':''}
	...
	def test_admin_user_edit(self):
		...
		val_dict = {'username':'test_user_edit', 'email':'test_user@gmail.com','pass_first':'testtest12345', 'pass_second':'testtest12345', 'nom':'', 'numero':'' }
		...
		for item in var_etude:
			self.assertIn(item.username, ['testuser1', 'testuser2','test_user_edit'])		

		post_user = self.client.post(reverse('user_edit', args=(id_user.id,)), data={'username':'user_edit', 'email':id_user.email, 'pass_first':'', 'pass_second':''})
	...
	def test_admin_user_del(self):
		...
		val_dict = {'username':'test_user_del', 'email':'test_user@gmail.com','pass_first':'testtest12345', 'pass_second':'testtest12345', 'nom':'', 'numero':'' }
		post_user = self.client.post(reverse('admin_utilisateur'), data=val_dict)
...
#---------------------------------------------------------------------------------------------
	...
	def test_admin_centre(self):
		...
		dict_centre = {'nom':'test_centre_create', 'numero':'569', 'date_ajout':'2020-02-02'}
	...
	def test_admin_centre_edit(self):
		...
		val_dict = {'nom':'test_centre_edit', 'numero':'9875', 'date_ajout':'2020-02-02'}
		...
		post_centre = self.client.post(reverse('centre_edit', args=(id_centre.id,)), data={'nom':'centre_edit', 'numero':'56987', 'date_ajout':'2020-02-02'})
	...
	def test_admin_centre_del(self):
		...
		val_dict = {'nom':'test_centre_del', 'numero':'6879', 'date_ajout':'2020-02-02'}
...
#---------------------------------------------------------------------------------------------
	...
	def test_admin_auth_edit(self):
		...
		val_dict = {'username':'test_user_Auth', 'email':'test_user@gmail.com','pass_first':'testtest12345', 'pass_second':'testtest12345', 'nom':'', 'numero':'' }
		post_user = self.client.post(reverse('admin_utilisateur'), data=val_dict)
