...
class TestApp(TestCase):
    ...
    def setUp(self):
        ...
        create_dossier = DossierUpload.objects.create(
            user=test_user1, controle_qualite=qc_insert, date=date_now
        )
        create_dossier.save()
    ...
    def test_upload(self):
        ...
        post_form = self.client.post(
            reverse("formulaire"), data=val_dict
        )
