...
def admin_page(request):
    ...
    for etude in etudes:
        ...
        resume_etat = {}
        resume_etat["data"] = json.dumps({"nbr": [exist_etude.count()],
                                          "nom": [etude.nom]
                                          })
    ...
    # etapes = RefEtapeEtude.objects.filter(nom__in=list_nom)

    # for etp in etapes:
    #     id_etape = etp.id
    #     jonction_dossier = JonctionEtapeSuivi.objects.filter(etape=id_etape).filter(etat=1)
    #     print(jonction_dossier)

    #     for object in jonction_dossier:
    #         dict_object = {}
    ...
    #         list_tab.append([dossier_first.id_patient,
    #                          date_ex,date_up,
