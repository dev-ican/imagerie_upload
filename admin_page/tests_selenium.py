...
class AccountTestCase(LiveServerTestCase):
	...
	def test_page_graphique(self):
		...
		self.assertEqual(selenium.find_element_by_name("titre_graphique").get_attribute("innerHTML").splitlines()[0], name_index)
	...
	def test_page_etude(self):
		...
		self.assertEqual(selenium.find_element_by_css_selector("h3.titre_etude").get_attribute("innerHTML").splitlines()[0], name_index)
	...
	def test_page_admin_etude(self):
		...
		self.assertEqual(selenium.find_element_by_name("titre_TabEtude").get_attribute("innerHTML").splitlines()[0], name_index)
	...
	def test_page_admin_etape(self):
		...
		self.assertEqual(selenium.find_element_by_name("titre_TabEtape").get_attribute("innerHTML").splitlines()[0], name_index)
	...
	def test_page_admin_centre(self):
		...
		self.assertEqual(selenium.find_element_by_name("titre_TabCentre").get_attribute("innerHTML").splitlines()[0], name_index)
	...
	def test_page_admin_auth(self):
		...
		self.assertEqual(selenium.find_element_by_name("titre_AutUser").get_attribute("innerHTML").splitlines()[0], name_index)
	...
	def test_page_admin_doc(self):
		...
		self.assertEqual(selenium.find_element_by_name("titre_document").get_attribute("innerHTML").splitlines()[0], name_index)
